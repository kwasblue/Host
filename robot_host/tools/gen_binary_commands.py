...
PY_BINARY_OUT = Path("/Users/kwasiaddo/projects/Host/robot_host/command/binary_commands.py")
PY_JSON_TO_BIN_OUT = Path("/Users/kwasiaddo/projects/Host/robot_host/command/json_to_binary.py")
...
def generate_py_json_to_binary() -> str:
    ...
    lines.append("    from robot_host.command.json_to_binary import JsonToBinaryEncoder")
    lines.append("    from robot_host.core.protocol import encode, MSG_CMD_BIN")
    lines.append("")
