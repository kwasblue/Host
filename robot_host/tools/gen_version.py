...
Generates:
  ...
  - Host: robot_host/config/version.py
"""
...
from pathlib import Path
from robot_host.tools.platform_schema import VERSION
...
def main() -> None:
    ...
    py_path  = Path("/Users/kwasiaddo/projects/Host/robot_host/config/version.py")
