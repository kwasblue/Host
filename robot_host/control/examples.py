...
Run with: python -m robot_host.control.examples
"""
...
def example_mass_spring_damper():
    ...
    from robot_host.control.design import reference_gain, check_stability
...
def example_dc_motor_velocity():
    ...
    """
    from robot_host.control import StateSpaceModel, lqr
    from robot_host.control.design import integral_gain
...
async def example_upload_to_mcu():
    ...
    print("""
    # Connect to robot
    from robot_host.command.client import RobotClient
    client = RobotClient(...)
    ...
    from robot_host.control.upload import enable_controller, enable_observer
...
def example_discretization_comparison():
    ...
    """
    from robot_host.control import StateSpaceModel, discretize
